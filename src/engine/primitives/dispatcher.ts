...
export function primitiveForAction(action: MotionAction): MotionPrimitive {
  ...
  switch (action.type) {
    ...
    case "right_peace_sign":
      return heldPosePrimitive(peaceSignPose("right"));
    case "left_peace_sign":
      return heldPosePrimitive(peaceSignPose("left"));
    case "both_peace_signs":
      return heldPosePrimitive(bothPeaceSignsPose());
    case "photo_peace_sign":
      return photoPeacePrimitive("right", intensity);
    case "finger_control":
    ...
    case "crouch":
      return crouchPrimitive(intensity);
